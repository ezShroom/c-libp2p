...
extern int base58_btc_encode(const uint8_t *data, size_t data_len, char *out, size_t out_len);
extern int base58_btc_decode(const char *in, uint8_t *out, size_t out_len);
