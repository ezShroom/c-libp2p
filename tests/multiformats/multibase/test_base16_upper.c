...
extern int base16_upper_encode(const uint8_t *data, size_t data_len, char *out, size_t out_len);
extern int base16_upper_decode(const char *in, uint8_t *out, size_t out_len);
...
int main(void)
{
    ...
    for (size_t i = 0; i < num_tests; i++)
    {
        ...
        int ret_dec = base16_upper_decode(encoded, decoded, decode_buf_size);
